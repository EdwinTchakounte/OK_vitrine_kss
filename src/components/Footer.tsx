      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li><span className="text-gray-400">🇨🇳 Bourses Chine</span></li>
              <li><span className="text-gray-400">🇨🇦 Bourses Canada</span></li>
              <li><span className="text-gray-400">🇩🇪 Bourses Allemagne</span></li>
              <li><span className="text-gray-400">📚 Préparation IELTS/TOEFL</span></li>
              <li><span className="text-gray-400">📋 Assistance visa</span></li>
            </ul>
          </div>
